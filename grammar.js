// Automatically converted from ANTLR grammar Dart-e9df8dceab89790ddc55c8d0ed388fcfe8fe879f.g by antlr2tree-sitter v0.0-9-gb317919.
// common bits
const epsilon = () => "";
const anythingBut = (s) => {
...
topLevelDefinition: $ => choice($.classDeclaration, $.mixinDeclaration, $.extensionTypeDeclaration, $.extensionDeclaration, $.enumType, $.typeAlias, seq($.EXTERNAL, $.functionSignature, ";"), seq($.EXTERNAL, $.getterSignature, ";"), seq($.EXTERNAL, $.setterSignature, ";"), seq($.EXTERNAL, $.finalVarOrType, $.identifierList, ";"), seq(optional($.AUGMENT), $.getterSignature, $.functionBody), seq(optional($.AUGMENT), $.setterSignature, $.functionBody), seq(optional($.AUGMENT), $.functionSignature, $.functionBody), seq(optional($.AUGMENT), choice($.FINAL, $.CONST), optional($.type), $.staticFinalDeclarationList, ";"), seq(optional($.AUGMENT), $.LATE, $.FINAL, optional($.type), $.initializedIdentifierList, ";"), seq(optional($.AUGMENT), optional($.LATE), $.varOrType, $.initializedIdentifierList, ";")),
...
classDeclaration: $ => choice(seq(optional($.AUGMENT), choice(classModifiers($), $.mixinClassModifiers), $.CLASS, $.typeWithParameters, optional($.superclass), optional($.interfaces), $.LBRACE, repeat(seq(metadata($), $.classMemberDeclaration)), $.RBRACE), seq(classModifiers($), optional($.MIXIN), $.CLASS, $.mixinApplicationClass)),
...
classMemberDeclaration: $ => choice(seq(optional($.AUGMENT), $.methodSignature, $.functionBody), seq($.declaration, ";")),
mixinApplicationClass: $ => seq($.typeWithParameters, "=", $.mixinApplication, ";"),
mixinDeclaration: $ => seq(optional($.AUGMENT), optional($.BASE), $.MIXIN, $.typeWithParameters, optional(seq($.ON, $.typeNotVoidNotFunctionList)), optional($.interfaces), $.LBRACE, repeat(seq(metadata($), $.mixinMemberDeclaration)), $.RBRACE),
mixinMemberDeclaration: $ => $.classMemberDeclaration,
extensionTypeDeclaration: $ => seq(optional($.AUGMENT), $.EXTENSION, $.TYPE, optional($.CONST), $.typeWithParameters, $.representationDeclaration, optional($.interfaces), $.LBRACE, repeat(seq(metadata($), $.extensionTypeMemberDeclaration)), $.RBRACE),
...
extensionDeclaration: $ => seq(optional($.AUGMENT), $.EXTENSION, optional($.typeIdentifierNotType), optional($.typeParameters), $.ON, $.type, $.LBRACE, repeat(seq(metadata($), $.extensionMemberDeclaration)), $.RBRACE),
extensionMemberDeclaration: $ => $.classMemberDeclaration,
...
declaration: $ => choice(seq($.EXTERNAL, $.factoryConstructorSignature), seq($.EXTERNAL, $.constantConstructorSignature), seq($.EXTERNAL, $.constructorSignature), seq(optional(seq($.EXTERNAL, optional($.STATIC))), $.getterSignature), seq(optional(seq($.EXTERNAL, optional($.STATIC))), $.setterSignature), seq(optional(seq($.EXTERNAL, optional($.STATIC))), $.functionSignature), seq($.EXTERNAL, choice(seq(optional($.STATIC), $.finalVarOrType), seq($.COVARIANT, $.varOrType)), $.identifierList), seq(optional($.EXTERNAL), $.operatorSignature), seq($.ABSTRACT, choice($.finalVarOrType, seq($.COVARIANT, $.varOrType)), $.identifierList), seq(optional($.AUGMENT), $.STATIC, choice($.FINAL, $.CONST), optional($.type), $.staticFinalDeclarationList), seq(optional($.AUGMENT), $.STATIC, $.LATE, $.FINAL, optional($.type), $.initializedIdentifierList), seq(optional($.AUGMENT), $.STATIC, optional($.LATE), $.varOrType, $.initializedIdentifierList), seq(optional($.AUGMENT), $.COVARIANT, $.LATE, $.FINAL, optional($.type), $.identifierList), seq(optional($.AUGMENT), $.COVARIANT, optional($.LATE), $.varOrType, $.initializedIdentifierList), seq(optional($.AUGMENT), optional($.LATE), choice(seq($.FINAL, optional($.type)), $.varOrType), $.initializedIdentifierList), seq(optional($.AUGMENT), $.redirectingFactoryConstructorSignature), seq(optional($.AUGMENT), $.constantConstructorSignature, optional(choice($.redirection, $.initializers))), seq(optional($.AUGMENT), $.constructorSignature, optional(choice($.redirection, $.initializers)))),
...
enumType: $ => seq(optional($.AUGMENT), $.ENUM, optional($.typeWithParameters), optional($.mixins), optional($.interfaces), $.LBRACE, $.enumEntry, repeat(seq(",", $.enumEntry)), optional(","), optional(seq(";", repeat(seq(metadata($), $.classMemberDeclaration)))), $.RBRACE),
...
cascade: $ => choice(seq($.cascade, "..", $.cascadeSection), seq($.conditionalExpression, choice("?..", ".."), $.cascadeSection)),
...
libraryName: $ => seq(metadata($), $.libraryNameBody, ";"),
libraryNameBody: $ => choice(seq($.LIBRARY, optional($.dottedIdentifierList)), seq($.AUGMENT, $.LIBRARY, $.uri)),
dottedIdentifierList: $ => seq($.identifier, repeat(seq(".", $.identifier))),
importOrExport: $ => choice($.libraryImport, $.libraryAugmentImport, $.libraryExport),
libraryImport: $ => seq(metadata($), $.importSpecification),
libraryAugmentImport: $ => seq(metadata($), $.IMPORT, $.AUGMENT, $.uri, ";"),
...
typeAlias: $ => choice(seq(optional($.AUGMENT), $.TYPEDEF, $.typeIdentifier, optional($.typeParameters), "=", $.type, ";"), seq(optional($.AUGMENT), $.TYPEDEF, $.functionTypeAlias)),
...
otherIdentifierNotType: $ => choice($.ASYNC, $.AUGMENT, $.BASE, $.HIDE, $.OF, $.ON, $.SEALED, $.SHOW, $.SYNC, $.WHEN),
...
[$.classDeclaration, $.mixinClassModifiers],
[$.typeAlias, $.builtInIdentifier],
[$.identifier, $.typeIdentifierNotType],
[$.topLevelDefinition, $.otherIdentifierNotType],
[$.topLevelDefinition, $.classDeclaration, $.otherIdentifierNotType],
[$.topLevelDefinition, $.extensionTypeDeclaration, $.extensionDeclaration, $.otherIdentifierNotType],
[$.topLevelDefinition, $.libraryNameBody, $.otherIdentifierNotType],
[$.topLevelDefinition, $.classDeclaration, $.mixinDeclaration, $.otherIdentifierNotType],
[$.topLevelDefinition, $.typeAlias, $.otherIdentifierNotType],
[$.classDeclaration, $.mixinClassModifiers, $.mixinDeclaration, $.otherIdentifierNotType],
[$.classDeclaration, $.otherIdentifierNotType],
...
[$.finalVarOrType],
[$.typeName, $.typeAlias],
[$.mixinClassModifiers, $.mixinDeclaration, $.otherIdentifierNotType],
...
[$.classMemberDeclaration, $.declaration, $.otherIdentifierNotType],
[$.classMemberDeclaration, $.otherIdentifierNotType],
